...
const Conocimientos = () => {
  ...
  return (
    <section className="text-gray-600 body-font  text-gray-600 body-font  w-full">
      <div className="flex items-center">
        ...
        <h1
          className="text-4xl font-extrabold text-end mt-40 mr-2 mb-8 container"
          id="proyecto"
        >
          {" "}
          CONOCIMIENTOS
      ...
      <div className="container  mt-20 px-5  mx-auto">
